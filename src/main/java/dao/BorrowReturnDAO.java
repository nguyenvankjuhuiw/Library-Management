...
public class BorrowReturnDAO extends Connect {
    ...
    public List<BorrowReturn> getBorrowReturnByReaderid(int readerid) throws SQLException {
        List<BorrowReturn> list = new ArrayList<>();
    ...
    public List<BorrowReturn> getBorrowReturnByReaderidAndNotReturn(int readerid)  throws SQLException {
        List<BorrowReturn> list = new ArrayList<>();
    ...
    public List<BorrowReturn> getBorrowReturnByReaderidAndReturn(int readerid)   throws SQLException {
        List<BorrowReturn> list = new ArrayList<>();
